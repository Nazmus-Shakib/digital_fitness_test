                  ...
                  action="{{ (@$editQuestion)?route('question.update',$editQuestion->id):route('question.save') }}" enctype="multipart/form-data">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="name" value="{{@$editQuestion->name}}" class="form-control" placeholder="Write Question here">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="number" name="weightage" value="{{@$editQuestion->weightage}}" class="form-control" placeholder="Write weightage here" min="1">
